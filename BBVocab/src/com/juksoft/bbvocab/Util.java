...
public class Util {
	...
	public static String removeString(String string, String stringToRemove) {
		StringBuffer stringBuffer = new StringBuffer(string);
		int indexFound = 0;
		while((indexFound = stringBuffer.toString().indexOf(stringToRemove)) != -1) {
			stringBuffer.delete(indexFound, indexFound + stringToRemove.length());
		}
		return stringBuffer.toString();
	}
	
	public static  String formatDefinitionForTextField(String definitionText) {
